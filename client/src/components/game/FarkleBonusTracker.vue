<template>
  <div class="flex items-center justify-between px-4 py-2 bg-card/50 rounded-xl border">
    <!-- Turn counter -->
    <div class="flex flex-col items-center">
      <span class="text-xs text-muted-foreground uppercase tracking-wide">Turn</span>
      <span class="text-2xl font-bold">{{ currentTurn }}<span class="text-muted-foreground text-lg">/3</span></span>
    </div>
    ...
    <div class="flex gap-3">
      ...
      >
        ...
        <span class="text-xs font-mono font-bold" :class="getBonusColorClass(el)">
          {{ getBonusDisplay(el) }}
        </span>
      </div>
    </div>
    ...
    <div class="flex flex-col items-center gap-0.5">
      <span class="text-xs text-muted-foreground uppercase tracking-wide">Chosen</span>
